...
REPODIRS="ScopeSim ScopeSim_Templates ScopeSim_Data irdb METIS_DRLD METIS_Simulations METIS_Pipeline METIS_Pipeline_Test_Data MetisWISE metis-meta-package MTR speXtra"
